...
const mockNotifications = [
    {
        ...
        read: false,
        details:
            "The token nx_live_83k92m1... has been successfully generated and distributed to the Singapore (sg-1) hub. No further action is required.",
    },
    {
        id: "2",
        title: "Cluster Optimization",
        description:
            "The US-East-1 cluster has been optimized for lower latency.",
        time: "45m ago",
        type: "info",
        read: true,
        details:
            "Traffic re-routing completed. Average TTL reduced by 15ms. Global load balancer updated.",
    },
    {
        id: "3",
        title: "Security Alert: Failed Login",
        description:
            "A suspicious login attempt was blocked from IP 45.12.8.192.",
        time: "2h ago",
        type: "alert",
        read: false,
        details:
            "A brute-force attempt was detected on your account. The IP origin is Moscow, RU. Security protocols have automatically blacklisted this range for 24 hours.",
    },
];
                                                ...
                                                >
                                                    ...
                                                    <div className="min-w-0">
                                                        <div className="flex justify-between items-start gap-2 mb-1">
                                                            <p
                                                                className={`text-xs font-bold truncate ${!notif.read ? "text-on-surface" : "text-on-surface-variant"}`}
                                                            >
                                                                {notif.title}
                                                            </p>
                ...
                {memberInfo ? (
                        ...
                        <AnimatePresence>
                            {isUserMenuOpen && (
                                ...
                                >
                                    ...
                                    >
                                        <LogOut className="w-4 h-4" /> Signed
                                        Out
                                    </button>
                                </motion.div>
                            )}
                    ...
                    >
                        <button
                            ...
                            className="relative text-tertiary-fixed hover:text-tertiary-fixed/70 cursor-pointer group focus:outline-none"
                        >
                            LogIn
                        </button>
                    </div>
                                ...
                                <div className="p-8">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="space-y-3">
                                            <p className="text-xs font-mono font-bold text-on-surface-variant uppercase tracking-widest">
                                                Detail Trace
                                            </p>
                        ...
                        <div className="fixed inset-0 z-110 flex items-start justify-center p-gutter">
                            ...
                            >
                                ...
                                <p className="text-on-surface-variant text-sm mb-8 leading-relaxed">
                                    Are you sure you want to terminate your
                                    active session in the global cluster? You
                                    will need to re-authenticate to access your
                                    tokens.
                                </p>
